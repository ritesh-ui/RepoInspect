...
class DetectedSnippet:
    def __init__(self, file_path, line_number, snippet, context_above, context_below, pattern_type, code_slice=None, tainted_vars=None, function_name="global", vulnerable_syntax=""):
...
PATTERNS = {
    ...
    'Command Execution': r'(?i)(os\.system|subprocess\.(run|call|Popen|check_output|check_call))\(',
